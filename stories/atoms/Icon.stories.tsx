...
import {
  ...
  //hce
  LogoCSFIcon, LogoSannaIcon, LogoSannaIsotipoIcon, LogoUnknownIcon, LogoUnknownIsotipoIcon, LogoutIcon, HceMenuIcon, HceStarIcon, HceConfigIcon,
...
const HCE_NoMapeado: { name: string; icon: React.FC<any> }[] = [
  { name: "LogoClinicaSanFelipeIcon",  icon: LogoCSFIcon },
