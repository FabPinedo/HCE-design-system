...
import "./PaginationGenericTable.css"
...
export const PaginationGenericTable = ({
  summary,
  currentPage,
  totalPages,
  onPageChange,
  ...
  return (
    ...
    >
      {/* casillas genericas */}
      {summary.map((item) => (
        <span key={item.label} className="hce-pag-chip">
