        ...
        <footer
          style={{
            ...
            borderTop:
              borderNone == true
                ? "none"
                : `1px solid ${hceColors.primary.blue[100]}`,
            flexShrink: 0,
            flexWrap: "wrap",
          }}
        >
          ...
          {primaryButton && (
            ...
            >
              <Button
                ...
                startIcon={
                  !primaryButton.loading && primaryButton.icon
                    ? primaryButton.icon
                    : undefined
                }
                testId={testId ? `${testId}-primary` : undefined}
                color={
                  primaryButton.color ?? `var(--ds-color-interactive, #003d96)`
                }
              >
                {primaryButton.loading ? (
                  ...
                  >
                    <span
                      className="hce-formmodal-spinner"
                      aria-hidden="true"
                    />
                    {primaryButton.label}
                  </span>
            ...
            >
              <Button
                ...
                color={
                  ...
                  `var(--ds-color-interactive, #003d96)`
                }
              >
